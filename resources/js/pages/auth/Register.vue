...
<template>
  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-200 via-pink-200 to-purple-200 animate-gradient px-4">
    ...
    <div class="w-full max-w-md p-8 bg-white/30 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/40 animate-fadeIn">
      ...
      <p class="mt-2 text-center text-gray-600 text-sm">Enter your details below to get started</p>
      ...
      >
        <div class="grid gap-6">
          ...
          <Button
            type="submit"
            class="w-full mt-2 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
            :disabled="processing"
          >
